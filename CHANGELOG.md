...
The outlines of the stromatolite reefs in Shark bay were refined to focus on areas where there are some vertical structure. This included excluding areas that were likely to just be microbial pavement (see https://doi.org/10.1016/j.margeo.2012.02.009).
