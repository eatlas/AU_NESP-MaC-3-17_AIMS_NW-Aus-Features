...
20. For southern reefs how did you tell if the reef was a coral reef?
22. What coastline was the reef boundaries clipped to?
24. How old are the paleo coastline rocky reef features?
26. Who develop this dataset and what part did they work on?
28. Did we not already know where reefs are?
30. You mapped the reefs manually. Would this not introduce biases and make the dataset not reproducible?
32. How do I make a map from the dataset?
34. How many reefs are there of each type?
36. Where has this dataset been used?
38. How can I tell if a particular reef or area is accurate?
