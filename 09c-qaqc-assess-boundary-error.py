...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--gtp",
        default="data/in/AU_Shallow-mask-boundary_qaqc/AU_Shallow-mask_gtp_B1.shp",
        help="Path to the ground truth points shapefile.",
    )
    parser.add_argument(
        "--regions",
        default="data/in/AU_NESP-MaC-3-17_Study-boundary/Reef-mapping-study-boundary.shp",
