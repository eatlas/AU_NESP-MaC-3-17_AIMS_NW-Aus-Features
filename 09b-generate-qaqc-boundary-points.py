...
is to ensure a more accurate assessment. The position of the polygon vertices tend to be more accurate
than the lines between them for roughly digitised features. 
