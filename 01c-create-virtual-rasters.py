#!/usr/bin/env python3
"""
Script: 01c-create-virtual-rasters.py
...
Usage:
    python 01c-create-virtual-rasters.py --base-dir <PATH_TO_TOP_LEVEL_DIRECTORY>
    If no --base-dir is provided, it defaults to the f'{in_3p_path}/S2' specified in `config.ini`.
...
if __name__ == "__main__":
    ...
    # Use the download path from config.ini as the default base directory
    parser.add_argument("--base-dir", default=f'{in_3p_path}/S2',
