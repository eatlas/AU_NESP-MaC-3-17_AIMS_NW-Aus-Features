...
python 01b-download-sentinel2.py --dataset low_tide_true_colour
python 01b-download-sentinel2.py --dataset low_tide_infrared
...
def get_tile_sets() -> Dict[str, Dict[str, List[str]]]:
    ...
    return {
        "15th_percentile": {
            "NAU": tile_ids_nw,
            "GBR": tile_ids_gbr,
            "all": tile_ids_nw + tile_ids_gbr
        },
        "low_tide_true_colour": {
            "NAU": tile_ids_nw_coastline,
            "GBR": tile_ids_gbr_coastal,
            "all": tile_ids_nw_coastline + tile_ids_gbr_coastal
        },
        "low_tide_infrared": {
            "NAU": tile_ids_nw_coastline,
            "GBR": tile_ids_gbr_coastal,
...
def main():
    ...
    parser.add_argument("--output", help="Specify the output directory for downloads", default=f"{download_path}/S2")
